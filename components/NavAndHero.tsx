  ...
  return (
    <div className="relative h-screen">
      ...
      <div className={`relative z-10 flex items-center justify-center h-[calc(100vh-4rem)] md:h-[calc(100vh-5rem)] ${isMenuOpen ? "-mt-28" : ""}`}>
        <div 
          className={`text-center text-white px-4 sm:px-6 lg:px-8 max-w-3xl glassmorphism p-5 sm:p-7 rounded-2xl backdrop-blur-xs bg-white/10 transition-all duration-1000 ease-in-out transform ${
